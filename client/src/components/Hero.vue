        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                ...
                <div class="text-center">
                    <h1 class="text-gray-900 dark:text-white font-bold text-5xl md:text-6xl xl:text-7xl">Your Path to Professional  <span class="text-primary dark:text-gray-350">Excellence.</span></h1>                    <p class="mt-6 text-lg leading-8 text-gray-600">Explore opportunities in diverse industries, gain real-world insights, and kickstart your career journey with us</p>
